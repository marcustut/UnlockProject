...
credentials_file_path = './templates/home/credentials/credentials.json'
clientsecret_file_path = './templates/home/credentials/client_secret.json'
...
def retrieve_all_files(api_service):
    ...
    while True:
        try:
            ...
            # append the files from the curret result page to our list
        ...
        except page_token.HttpError as error:
